...
(function($) {
	...
	$.fn.smartMenu = function(data, options) {
		...
		$(this).each(function() {
			//right button menu is default
			var menuType = params.type||'right';
			if(menuType == 'right'){
				this.oncontextmenu = popUpSmartMenu;
			}else{
				this.onclick = popUpSmartMenu;
			}
		});

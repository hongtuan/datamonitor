...
function scatterPlot3d( parent ) {
  ...
  var defaultDuration = 1600;
  var ease = 'linear';
  var time = 0;
  var axisKeys = ["x", "y", "z"];
  var axisRotation = [[0,0,0,0],[0,0,1,Math.PI/2],[0,1,0,-Math.PI/2]];
  //var axisRotation = [[0,0,0,0],[0,0,1,Math.PI/2],[0,1,0,-Math.PI/2]];
  ...
  function initializeAxis( axisIndex ) {
    ...
    var newAxisLine = scene.append("transform")
         ...
         .attr("rotation", (axisRotation[axisIndex]))
      .append("shape");
    newAxisLine
      .append("appearance")
      .append("material")
  ...
  function initializeDataGrid() {
    ...
    rows.push({x: 12, y: 0, z: 20});
    rows.push({x: 22, y: 0, z: 60});
    rows.push({x: 52, y: 0, z: 10});
    return rows;
  }
